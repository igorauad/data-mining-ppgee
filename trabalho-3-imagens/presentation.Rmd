...
### Paramentros do método de correlação
Dados de treino

1702 imagens positivas

Janelas de pixels (patch) de $11\times 11$, $13\times 13$ à $23\times 23$
...
Sensibilidade:
\[
FVP = \frac{VP}{VP+FN} = \frac{VP}{P}
\]


1 - Especificidade: 
\[
FFP = \frac{FP}{FP+VN} = \frac{FP}{N}
\]
...
pesquisa em janelas de pixels de $5\times 5$, $7\times 7$ e $9\times 9$ centradas na média dos pontos chaves das imagens de treino.
\\\\\\\\
...
3. Classificador treinado com 8 estágios, $FAR=0.2$, $TPR=0.995$ e FeatureType = Haar
...
* Primeiramente, toma-se o erro médio quadrático, de forma independente, entre os 4 pontos real e detectado

* O RMSE geral é a média aritmética entre os 4 RMSEs acima


![RMSEs Viola Jones](./figs/RMSEs_violaJones.png)
