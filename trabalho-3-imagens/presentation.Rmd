...
* Imagem Integral (*Integral Image Representation*) - citação - método de Viola-Jones

## Features retangulares e a Representação Imagem Integral

* Features retangulares: reminescentes das funções base de wavelets Haar
...
* "dois-retângulos": 6 (reduz-se de 8 pra 6 devido serem adjacentes)
* "três-retângulos": 8
* "quatro-retângulos": 9

**Nota**: o conjunto de Features retangulars provê uma representação rica para aprendizado, a qual captura padrões em orientação horizontal, vertical e diagonal.
