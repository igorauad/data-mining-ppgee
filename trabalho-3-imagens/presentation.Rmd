...
* *Weak learners*: classificadores simples (ao menos melhores que chute aleatório)
* *Boosting*: provê a habilidade de treinar um classificador (*strong*) com alta acurácia a partir da combinação linear das decisões feitas por *weak learners* $$f = \alpha_0 f_0 + \alpha_1 f_1 + \cdots + \alpha_N f_N$$
...
![Treinamento do Classificador](./figs/cascadeTraining.png)
...
* **Mais estágios**:
    ...
    * Necessita de mais dados de treinamento:
      * Imagens negativas, pois somente falsos-positivos são passados como imagens negativas aos estágios seguintes
      * Imagens positivas, pois falsos-negativos são descartados em cada estágio

### Práticas
* Como a base de dados é relativamente grande, pode-se aumentar o número de estágios e relaxar (aumentar) as especificações de taxa de falsos-positivos em cada estágio (menos *weak learners*)
